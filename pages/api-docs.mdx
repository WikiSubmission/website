...
<Callout>
 You can add a "`customProperties`" query to a request URL to return **only** return the properties you need (e.g. `.../quran/1/?customProperties=verse_id,verse_text_english`). Use with caution for type-sensitive languages.
</Callout>
